...
export const metadata: Metadata = generateMetadata({
  title: "About Dr. Janie Forbes | Board-Certified Family Medicine & Medical Acupuncture Phoenix",
  description: "Meet Dr. Janie Forbes, board-certified Family Medicine physician and medical acupuncturist in Phoenix. Penn State Medicine graduate, UVA Chief Resident with Marma therapy certification.",
  keywords: ["Dr Janie Forbes Phoenix", "board certified family medicine Phoenix", "medical acupuncturist Phoenix", "Penn State Medicine", "UVA Chief Resident", "Marma therapy Phoenix", "family medicine physician Phoenix"],
  canonical: "/about",
